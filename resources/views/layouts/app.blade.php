...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/home" class="logo">
      ...
      <span class="logo-mini"><b>2</b>C</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>2</b>CALL</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('/images/default-avatar.svg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('/images/default-avatar.svg') }}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                    {{ Auth::user()->name }} - @foreach(Auth::user()->roles as $roles => $name)
                                                    {{  $name->name  }}
                                                @endforeach
                  <small>Ingreso Nov. 2012</small>
                </p>
              </li>
              <!-- Menu Footer-->
